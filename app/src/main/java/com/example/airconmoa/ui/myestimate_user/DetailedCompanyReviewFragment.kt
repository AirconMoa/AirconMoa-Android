...
class DetailedCompanyReviewFragment : BaseFragmentVB<FragmentDetailedCompanyReviewBinding>(
    FragmentDetailedCompanyReviewBinding::bind,
    R.layout.fragment_detailed_company_review
) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TabLayoutMediator(binding.tabDetailedCompany, binding.vpDetailedCompany) { tab, position ->
